  ...
  return (
    <Wrapper>
      <div className="article_container">
        ...
        <p className="texts">
          {localStorage.getItem("CourseText")
            ? localStorage.getItem("CourseText")
            : ""}
        </p>
        ...
        <p className="texts">
          ...
          importance of all courses cannot be overstated. They empower
          ...
          expertise, or expanding your understanding of the world, every course
        ...
        <p className="texts">
          For lifelong learners, courses fuel curiosity and enrich lives by
          exposing them to diverse topics, cultures, and ideas. Each course
          holds unique value because it caters to different needs, aspirations,
          and stages of life. From science and technology to arts and
          humanities, every course builds bridges between theory and practice,
          helping learners apply their knowledge in real-world scenarios. Power
      ...
      <div className="article_container">
        <h2 className="title">Course Requirement</h2>

        <p className="texts">
          Courses are vital tools for personal and professional growth, offering
          structured learning experiences to expand knowledge, develop skills,
          and achieve goals. Regardless of the field or subject, every course
          plays an essential role in shaping individuals into well-rounded,
          competent, and informed contributors to society. For students, courses
          provide foundational knowledge and insights that form the basis of
          their academic and career paths. For professionals, courses offer
